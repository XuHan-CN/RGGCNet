...
def main():
    ...
    # Dataset
    parser.add_argument('--dataset', default='LPMT', help='Dataset name: LPMT')
    ...
    if args.dataset=='LPMT':
        import LPMT_dataset
        dbinfo = LPMT_dataset.get_info(args)
        create_dataset = LPMT_dataset.get_datasets
    else:
